...
export function SelectionPopover({ x, y, text, onAsk, onDismiss }: Props) {
    ...
    >
      <div className="w-[380px] overflow-hidden rounded-xl border border-neutral-800 bg-[#0d0d11]/95 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.8)] ring-1 ring-white/5 backdrop-blur-xl">
        ...
        <div className="flex items-end gap-2 p-2">
          ...
          <button
            onClick={submit}
            className="group flex items-center gap-1.5 rounded-md bg-indigo-600 px-3 py-2 text-[12px] font-medium text-white shadow-[0_4px_14px_-4px_rgba(99,102,241,0.6)] transition hover:bg-indigo-500"
          >
            {hasQ ? 'Ask' : 'Explain'}
